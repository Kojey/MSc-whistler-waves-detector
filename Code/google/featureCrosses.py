...
def construct_feature_clolumns(training_examples):
	...
	# Make a feature cloumn for the long_x_lat feature cross
	long_x_lat = tf.feature_column.crossed_column(
		set([bucketized_longitude, bucketized_latitude]), hash_bucket_size=1000)

	area_x_room_per_person = tf.feature_column.crossed_column(
		set([bucketized_rooms_per_person, long_x_lat]), hash_bucket_size=1000)

	area_x_median_income = tf.feature_column.crossed_column(
		set([bucketized_median_income, long_x_lat]), hash_bucket_size=500)
	...
	feature_columns = set([
		...
		long_x_lat,
		area_x_room_per_person,
		area_x_median_income])
